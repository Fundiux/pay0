...
| Publicado / validación pendiente | 4 | `XLSX-01`, `QA-01`, `MAT-01` y `FAC-01`: código publicado o preparado, con checks de compilación; falta el smoke específico indicado en cada fila. |
