...
| 2026-09-10 | WAL-02 | PENDIENTE DE IMPLEMENTACIÓN | Reemplazar lectura por scope con query directa por cliente y cursor. | Segunda tarea de F1; requiere pruebas de saldo/historial. |
...
| WAL-02 | ABIERTO | P1 | Wallet / estado de cuenta | El detalle de Wallet limita movimientos, adelantos y dispersiones por scope antes de filtrar por cliente; puede truncar el historial y saldos presentados a un cliente. | Queries por cliente+scope con cursor/rango y pruebas de historial superior a 1,000 registros del root. |
