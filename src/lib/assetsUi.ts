...
export const assetStatusLabel = (status: string, kind?: string) => status === "ACTIVE" ? (kind === "VEHICLE" ? "Activa" : "Activo") : status === "LIQUIDATED" ? (kind === "VEHICLE" ? "Liquidada" : "Liquidado") : status === "CLOSED" ? "Cerrado" : "En revisión";
