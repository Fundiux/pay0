...
export type ComplementInventoryException = { applicationId: string; applicationFolio: string; solicitudFolio: string; pagoFolio: string; provider: string; outcome: "PENDING" | "ERROR"; reason: string };
