...
export async function reconcileAgent007RecommendationsNow() { return (await httpsCallable<Record<string, never>, { ok: boolean; changed: number }>(functions, "reconcileAgent007RecommendationsNow")({})).data; }
