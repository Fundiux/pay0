...
export default function PaymentComplementFollowup() {
  ...
  return <section className="rounded-2xl border border-white/10 bg-slate-900 p-4 text-slate-200">
    ...
    <p className="my-3 text-xs text-amber-200">Aplicaciones PPD nuevas: IQ solicita por depósito confirmado; Facturama emite con datos fiscales validados. IQ se revisa a las 19:00 (Ciudad de México), con aviso tras 7 días sin recibirlo. No se envía WhatsApp ni se solicita el histórico automáticamente.</p>
