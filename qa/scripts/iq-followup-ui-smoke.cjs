...
async function run(){
  ...
  try{
    ...
    await expect(page.getByText('La solicitud y descarga automática en IQ todavía no están conectadas.',{exact:false})).toBeVisible();
